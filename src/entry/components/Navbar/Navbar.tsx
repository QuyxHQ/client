...
const Navbar = () => {
  const { isWalletConnected, userInfo, isNetworkSupported, switchChain } = useAppStore();
          ...
          <div className="col-12">
            <div className="d-flex align-items-center justify-content-between px-2">
              ...
              >
                ...
                <div className="icon d-flex d-md-none pointer">
                ...
                {isWalletConnected ? (
                  !isNetworkSupported ? (
                    <button
                      className="gradient-border px-4"
                      style={{ whiteSpace: "nowrap", fontSize: "0.8rem", fontWeight: 600 }}
                    ...
                    <div className="user d-flex align-items-center">
                      <button>
                        <div className="d-flex align-items-center px-0 px-sm-1 px-md-0 px-lg-2">
                          ...
                          <span className="d-none d-sm-block d-md-none d-lg-block">-.-- ETH</span>
                        </div>
                      </button>
