...
const CNftItem_getters: ABIGetter[] = [
    {"name":"get_metadata","arguments":[],"returnType":{"kind":"simple","type":"CardMetadata","optional":true}},
    {"name":"get_nft_data","arguments":[],"returnType":{"kind":"simple","type":"ItemData","optional":false}},
    {"name":"get_authority_address","arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
...
export class CNftItem implements Contract {
    ...
    static async init(collection_address: Address, owner: Address, index: bigint, individual_content: Cell) {
        return await CNftItem_init(collection_address, owner, index, individual_content);
    }
    
    static async fromInit(collection_address: Address, owner: Address, index: bigint, individual_content: Cell) {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Initialize | GetStaticData | ProveOwnership | RequestOwner | Transfer | Destroy | Revoke) {
