...
type FixedSaleContract_init_args = {
    $$type: 'FixedSaleContract_init_args';
    mp_addr: Address;
    nft_addr: Address;
    created_at: bigint;
...
function initFixedSaleContract_init_args(src: FixedSaleContract_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.mp_addr);
        b_0.storeAddress(src.nft_addr);
...
async function FixedSaleContract_init(
    mp_addr: Address,
    nft_addr: Address,
    created_at: bigint,
    body: Cell
    ...
    const __code = Cell.fromBase64(
        ''
    );
    const __system = Cell.fromBase64(
        ''
    );
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initFixedSaleContract_init_args({
        $$type: 'FixedSaleContract_init_args',
        mp_addr,
        nft_addr,
        created_at,
...
const FixedSaleContract_errors: { [key: number]: { message: string } } = {
...
const FixedSaleContract_types: ABIType[] = [
    {
        name: 'StateInit',
        header: null,
        fields: [
...
const FixedSaleContract_getters: ABIGetter[] = [
    {
        name: 'get_sale_data',
        arguments: [],
        returnType: { kind: 'simple', type: 'SaleData', optional: false },
    },
    {
        name: 'get_fix_price_data',
        arguments: [],
        returnType: { kind: 'simple', type: 'FixPriceData', optional: false },
    },
];

const FixedSaleContract_receivers: ABIReceiver[] = [
...
export class FixedSaleContract implements Contract {
    static async init(mp_addr: Address, nft_addr: Address, created_at: bigint, body: Cell) {
        return await FixedSaleContract_init(mp_addr, nft_addr, created_at, body);
    }

    static async fromInit(mp_addr: Address, nft_addr: Address, created_at: bigint, body: Cell) {
        const init = await FixedSaleContract_init(mp_addr, nft_addr, created_at, body);
        const address = contractAddress(0, init);
        return new FixedSaleContract(address, init);
    }

    static fromAddress(address: Address) {
        return new FixedSaleContract(address);
    }

    readonly address: Address;
    readonly init?: { code: Cell; data: Cell };
    readonly abi: ContractABI = {
        types: FixedSaleContract_types,
        getters: FixedSaleContract_getters,
        receivers: FixedSaleContract_receivers,
        errors: FixedSaleContract_errors,
    };
    ...
    async send(
        ...
        message: null | OwnershipAssigned | CancelSale | BuyNFT
    ) {
    ...
    async getGetSaleData(provider: ContractProvider) {
        ...
        const result = loadTupleSaleData(source);
        return result;
    }

    async getGetFixPriceData(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('get_fix_price_data', builder.build())).stack;
        const result = loadTupleFixPriceData(source);
        return result;
    }
}
