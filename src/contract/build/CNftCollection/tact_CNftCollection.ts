...
export class CNftCollection implements Contract {
  ...
  async send(
    ...
    if (
      ...
      typeof message === "object" &&
      !(message instanceof Slice) &&
      message.$$type === "ReportUsernameData"
    ) {
