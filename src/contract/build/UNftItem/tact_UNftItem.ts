...
export class UNftItem implements Contract {
  ...
  async send(
    ...
    message: null | GetStaticData | GetUsernameData | Transfer | ReportCardLinkStatus
  ) {
