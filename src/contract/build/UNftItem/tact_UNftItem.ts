...
const UNftItem_getters: ABIGetter[] = [
    {"name":"get_nft_data","arguments":[],"returnType":{"kind":"simple","type":"ItemData","optional":false}},
    {"name":"get_token_name","arguments":[],"returnType":{"kind":"simple","type":"cell","optional":false}},
...
export class UNftItem implements Contract {
    ...
    static async init(collection_address: Address, owner: Address, index: bigint, individual_content: Cell, royalty: RoyaltyParams) {
        return await UNftItem_init(collection_address, owner, index, individual_content, royalty);
    }
    
    static async fromInit(collection_address: Address, owner: Address, index: bigint, individual_content: Cell, royalty: RoyaltyParams) {
        const init = await UNftItem_init(collection_address, owner, index, individual_content, royalty);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | GetStaticData | GetUsernameData | Transfer | ReportCardLinkStatus) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'GetUsernameData') {
