...
const UNftCollection_getters: ABIGetter[] = [
  {
    name: "username_link_status",
    arguments: [{ name: "username", type: { kind: "simple", type: "string", optional: false } }],
    returnType: { kind: "simple", type: "bool", optional: true },
  },
  {
    name: "get_username_hash",
    arguments: [{ name: "username", type: { kind: "simple", type: "string", optional: false } }],
...
export class UNftCollection implements Contract {
  ...
  static async fromInit(
    ...
    const init = await UNftCollection_init(
      collection_uri,
      protocol_address,
      default_royalty_params
    );
  ...
  async send(
    ...
    if (
      ...
      message.$$type === "GetCardLinkStatus"
    ) {
    ...
    if (
      ...
      typeof message === "object" &&
      !(message instanceof Slice) &&
      message.$$type === "UpdateAllowedContract"
    ) {
    ...
    if (
      ...
      typeof message === "object" &&
      !(message instanceof Slice) &&
      message.$$type === "UpdateUsernameLinkedStatus"
    ) {
